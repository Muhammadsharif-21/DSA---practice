    ...
    while(ptr!=NULL)
    {
      ...
      printf("Node doesn't exist");
         ...
         { 
            ...
            printf("Selected Node has been deleted");
            }
         }   
      }      
               ...
               if(root==NULL)
               ...
               else  
                   {
                     ...
                     ptr=root;
                      ...
                      printf("item found at %d node",loc);
                   }
           } 
